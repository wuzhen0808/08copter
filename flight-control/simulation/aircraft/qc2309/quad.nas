...
var update_quad = func( ) {
    ...
    setprop("/apm/motor_0",  round10(getprop("/engines/engine[0]/rpm")/10.0));
    setprop("/apm/motor_1",   round10(getprop("/engines/engine[1]/rpm")/10.0));
    setprop("/apm/motor_2",  round10(getprop("/engines/engine[2]/rpm")/10.0));
    setprop("/apm/motor_3",   round10(getprop("/engines/engine[3]/rpm")/10.0));
}
